...
export default function LaporanCheckout({ mode, data, loaded, filters }: Props) {
    ...
    const handleFilter = () => {
        ...
        router.get('/laporan/checkout', params, { preserveState: true });
    };
    ...
    const handleExportPdf = () => {
        ...
        window.open(`/laporan/checkout/export-pdf?${params.toString()}`, '_blank');
    };

    return (
        <>
            <Head title="Laporan Check-out" />
...
LaporanCheckout.layout = {
    breadcrumbs: [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Laporan Check-out', href: '/laporan/checkout' },
    ],
};
